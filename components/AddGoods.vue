      ...
      <div class="grid grid-cols-8 gap-20">
        <div class="col-span-6">
          ...
          <div class="flex flex-col gap-40">
            <div class="col">
              ...
              <Button size="large" class="!rounded-2xl">
                Скачать шаблон
              </Button>
            </div>
            <div class="col">
              ...
              <div class="flex w-570 items-center gap-20">
                ...
                <p class="text-lg">
                  Внесите информацию о товарах вашего склада в соответствующие
                  поля таблицы.
                </p>
              </div>
            </div>
        ...
        <div class="col-span-2">
          <div class="p-30 rounded-2xl bg-gray-100">
            <h3 class="mb-12">Если нужна помощь</h3>
            <p>
              Вы можете задать вопрос в чате нашему менеджеру прямо по этой
              кнопке
            </p>
            <Button size="large" class="!rounded-2xl mt-20">
              Помощь менеджера
            </Button>
          </div>
        </div>
