...
<template>
  <div>
    <Button v-if="!authStore.isAuthenticated" label="Войти" class="w-140 h-50 !rounded-2xl" severity="secondary" @click="DialogShow = true"/>
    <Dialog v-if="!authStore.isAuthenticated" v-model:visible="DialogShow" modal class="w-840" :show-header="false" content-class="!p-40">
      <Button
      ...
      <div class="flex flex-col gap-24">
        <Image class="w-full rounded-xl overflow-hidden" src="/images/header/login.jpg" alt="login" image-class="w-full"/>
